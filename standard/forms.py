...
from standard.conf import *
from standard.widgets import ValueHiddenInput, ReservedValueHiddenInput
from standard.conf import (POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT, 
    RECEIVER_EMAIL)
...
class PayPalPaymentsForm(forms.Form):
    ...
    def renderProd(self):
        return mark_safe(u"""<form action="%s"  style = "font-size:100px" method="post">
    %s
