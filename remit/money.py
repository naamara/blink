...
class Currency:
	...
	def __init__(self, code="", numeric="256", name="", countries=[]):
		self.code = code
...
CURRENCY = {}
CURRENCY['UGX'] = Currency(code="UGX", numeric="256")
DEFAULT_CURRENCY = CURRENCY['UGX']

def set_default_currency(code="UGX"):
...
CURRENCY['UGX'] = Currency(code='UGX', numeric='999', name='The codes assigned for transactions where no currency is involved are:', countries=[])
