...
from accounts.forms import SignupForm, AuthenticationForm, UserDetailsForm, AccessRestrictedForm, VerifyPhoneForm, PassportUploadForm, PassportUploadForm_jumio, RecoverPasswordForm, SetPasswordForm, landingSendForm, PasswordChangeForm, UpdatePhonenumberForm, UpdateEmailForm, UpdateAvatarForm
